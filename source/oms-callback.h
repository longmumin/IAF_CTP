#ifndef OMS_CALLBACK_H
#define OMS_CALLBACK_H

#include "oms_plugins.h"
...
class OMSCallback : public CThostFtdcTraderSpi
{
public:

	OMSCallback(OMS_Transport* pTransport, HANDLE& loginHandle);
...
private:
	...
	void addChar(char* buf, int size, struct AP_NormalisedEvent* ev, AP_NormalisedEventKey key, char value);
